...
class App {
    ...
    _map;       // Should be private #
    _mapEvent;   // Should be private #
    _workouts = [];
    _mapZoom = 13;
    ...
    _loadMap(position) {
            ...
            this._workouts.forEach(w => this.renderWorkoutMarker(w));
    }
    ...
    _newWorkout(e) {
        ...
        // Create cycling if workout is cycling
        if(type === 'cycling') {
    ...
    _getLocalStorage() {
        ...
        this._workouts.forEach(w => this._renderWorkout(w));
